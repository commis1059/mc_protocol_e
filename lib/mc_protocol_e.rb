...
require 'mc_protocol_e/frame_1e/access_route'
require 'mc_protocol_e/frame_1e/batch_read_in_word'
require 'mc_protocol_e/frame_1e/batch_write_in_word'
require 'mc_protocol_e/frame_1e/device_range'
...
require 'mc_protocol_e/frame_3e/response'
